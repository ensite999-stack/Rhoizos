...
export default function DropcatchRequest(){
  const {t}=useI18n();
  ...
  function requireLogin(){
    location.replace("/login?next="+encodeURIComponent("/dropcatch/request"));
  }
  ...
  return <div className="page wide">
    <BackLink fallbackHref="/dropcatch"/>
    <p className="kicker">{t("dropcatch.kicker")}</p>
    <h1 className="pageTitle">{t("dropcatch.requestTitle")}</h1>
    <p className="pageIntro">{t("dropcatch.requestCopy")}</p>
