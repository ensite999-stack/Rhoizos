...
export default function ForwardingInfo(){
  ...
  return <div className="page wide serviceLanding">
    ...
    <div className="serviceSteps">
      <article><span>01</span><h2>{t("forwarding.publicStep1Title")}</h2><p>{t("forwarding.publicStep1Copy")}</p></article>
      <article><span>02</span><h2>{t("forwarding.publicStep2Title")}</h2><p>{t("forwarding.publicStep2Copy")}</p></article>
      <article><span>03</span><h2>{t("forwarding.publicStep3Title")}</h2><p>{t("forwarding.publicStep3Copy")}</p></article>
    </div>
    <div className="serviceGate">
      <strong>{t("forwarding.manage")}</strong>
      <p>{t("domains.publicCopy")}</p>
      <div className="serviceCta">
        <Link className="primaryLink" href="/domains">{t("forwarding.manage")}</Link>
