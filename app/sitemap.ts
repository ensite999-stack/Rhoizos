...
{url:SITE_URL+"/dropcatch",lastModified:now,changeFrequency:"weekly",priority:.7},
{url:SITE_URL+"/forwarding",lastModified:now,changeFrequency:"monthly",priority:.6},
{url:SITE_URL+"/email-forwarding",lastModified:now,changeFrequency:"monthly",priority:.6},
