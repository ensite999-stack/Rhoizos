...
const en:Record<string,string>={
  ...
  "operations.copy":"Registrar-side asynchronous work and failures.","pricing.copy":"Manage registrar costs. Customer prices are calculated automatically from the fixed pricing policy.",
...
const fr={...en,
  ...
  "orders.copy":"État du paiement et du provisioning pour chaque commande.","operations.copy":"Opérations asynchrones côté registrar et échecs.","pricing.copy":"Gérez les coûts d’enregistrement. Les prix clients sont calculés automatiquement selon la règle fixe.",
...
const es={...en,
  ...
  "orders.copy":"Estado de pago y aprovisionamiento de cada pedido.","operations.copy":"Operaciones asíncronas del registrador y errores.","pricing.copy":"Gestiona los costes de registro. Los precios al cliente se calculan automáticamente según la regla fija.",
