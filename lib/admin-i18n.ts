...
const en:Record<string,string>={
  ...
  "operations.copy":"Registrar-side asynchronous work and failures.","pricing.copy":"Provider cost, global markup, per-TLD markup and fixed retail overrides.",
  ...
  "loadingPricing":"Loading pricing…","registerMarkup":"Register markup %","renewMarkup":"Renew markup %","transferMarkup":"Transfer markup %",
...
const zhCN={...en,
  ...
  "orders.copy":"每笔注册商订单的支付与交付状态。","operations.copy":"注册商侧异步操作与失败记录。","pricing.copy":"管理上游成本、全局加价、单 TLD 加价和固定零售价。",
  ...
  "loadingPricing":"正在加载价格…","registerMarkup":"注册加价 %","renewMarkup":"续费加价 %","transferMarkup":"转入加价 %",
...
const zhTW={...zhCN,
  ...
  "orders.copy":"每筆註冊商訂單的付款與交付狀態。","operations.copy":"註冊商端非同步操作與失敗記錄。","pricing.copy":"管理上游成本、全域加價、單 TLD 加價和固定零售價。",
  ...
  "loadingPricing":"正在載入價格…","registerMarkup":"註冊加價 %","renewMarkup":"續費加價 %","transferMarkup":"轉入加價 %",
...
const fr={...en,
  ...
  "orders.copy":"État du paiement et du provisioning pour chaque commande.","operations.copy":"Opérations asynchrones côté registrar et échecs.","pricing.copy":"Coûts fournisseur, marges globales, marges par TLD et prix fixes.",
  ...
  "loadingPricing":"Chargement des tarifs…","registerMarkup":"Marge enregistrement %","renewMarkup":"Marge renouvellement %","transferMarkup":"Marge transfert %",
...
const es={...en,
  ...
  "orders.copy":"Estado de pago y aprovisionamiento de cada pedido.","operations.copy":"Operaciones asíncronas del registrador y errores.","pricing.copy":"Coste del proveedor, margen global, margen por TLD y precios fijos.",
  ...
  "loadingPricing":"Cargando precios…","registerMarkup":"Margen registro %","renewMarkup":"Margen renovación %","transferMarkup":"Margen transferencia %",
